...
$sql = "INSERT INTO bagmen (name,dsc,amt,img) values('$name2','$desc',$amt,'Uploads/$name');";
...
<div class="content-input-field">
                            <button type="submit" class="btn" id="submit" onclick="move()"value="Login"> LOG OUT  </button>
							<button type="submit" class="btn" id="submit" onclick="move()"value="Login"> ADD ITEM </button>
                       </div>
</body >
