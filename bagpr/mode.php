            ...
            <div class="left-ads-display wthree">
				...
				while ($row=mysqli_fetch_row($data))
				{
					...
					echo "<h2><b>Quantity</b></h2>";
                        ...
                        echo "<h2><b>choose the mode of payment</b></h2>";
                       echo "<div class=quantity>";
                        echo "<input type=radio name=credit value=credit>Credit";
						echo "</div>";
					   echo "<div class=quantity>";
                        echo "<input type=radio name=credit value=credit>Google Pay";
						echo "</div>";
					     echo "<div class=quantity>";
								echo "<input type=radio name=credit value=credit> cash on delvry";
                       echo "</div>";
					   echo "</div>";
				}	   
			    ?>
